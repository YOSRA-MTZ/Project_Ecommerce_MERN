          ...
          <div className="hidden lg:block col-span-1 flex text-gray-600 mt-1">
            ...
            <span
              className={`${location.pathname === "/" ? "bg-gray-200" : ""
                } px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer`}
            ...
            {/* Élément "Blog" */}
            <span
              className={`${location.pathname === "/blog" ? "bg-gray-200" : ""
                } px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer`}
            ...
            {/* Élément "Contact us" */}
            <span
              className={`${location.pathname === "/contact-us" ? "bg-gray-200" : ""
                } px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer`}
